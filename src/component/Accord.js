            ...
            <div class="accordion" id="accordionExample">
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingTwo">
                  ...
                  >
                    <h4> How do I create and sell NFTs on Polygon?</h4>
                  </button>
                </h2>
                <div
                  id="collapseTwo"
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingThree">
                  ...
                  >
                    <h4>What is Freezing Metadata</h4>
                  </button>
                </h2>
                <div
                  id="collapseThree"
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingfour">
                  ...
                  >
                    <h4> Does Opensea allow physical item trades?</h4>
                  </button>
                </h2>
                <div
                  id="collapsefour"
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="headingfive">
                  <button
                    ...
                    aria-controls="collapseTwo"
                  >
                    <h4> How do I add a collection collaborator?</h4>
                  </button>
                </h2>
                <div
                  id="collapsefive"
